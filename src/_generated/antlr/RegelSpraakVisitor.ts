...
import { UnitProductContext } from "./RegelSpraakParser";
...
import { DagsoortVragendExprContext } from "./RegelSpraakParser";
...
export default class RegelSpraakVisitor<Result> extends ParseTreeVisitor<Result> {
	...
	/**
	 * Visit a parse tree produced by the `BeslistabelUnaryVoorwaardeHeader`
	 * labeled alternative in `RegelSpraakParser.beslistabelVoorwaardeHeader`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by `RegelSpraakParser.unitProduct`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by the `DagsoortVragendExpr`
	 * labeled alternative in `RegelSpraakParser.comparisonExpression`.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	visitDagsoortVragendExpr?: (ctx: DagsoortVragendExprContext) => Result;
	/**
	 ...
	 * @return the visitor result
	 */
	visitUnaryCheckVragendCondition?: (ctx: UnaryCheckVragendConditionContext) => Result;
	/**
